...
Mathematic uses AI agents to maintain this repository. Reviewing an unsolicited pull request usually takes longer than having an agent implement an agreed proposal.

## Start with a Discussion

If you want to contribute:

1. [Start a Discussion](../../discussions/new) describing the problem and your proposed solution.
